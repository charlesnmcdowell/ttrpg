...
I sit on the alcove stone, eyes closed. Bracelet warms; the network unfolds in my chest — glass bodies, pins, status.

Quick tally out loud — nobody here but me and the hum:

"Varenholm four — Elara's 'guards.' Convergence sixty-one — Senna's ring. North nineteen — Dren's column holding the dead relay. East eight — ravine pickets."

Solveth: *Towns?*

"Duskfen, Antler, Mines, Thornwall, Crestfall — zero. We stripped them for the assault."

Ninety-two up. Twelve gone to shrapnel and bad luck. Dawn spawns another thirty-two into empty town frames unless I change orders — math says a hundred twenty-four by breakfast if I do nothing.

---

First order — Elara's four: stand down, march to Bleakmoor, join the ring.

They move before I finish the thought. Four gold traces leave the courtyard, vanish through the portal. Elara'll wake to empty stairs and a lecture I deserve.

Second order — everything on-moor. Wide patrol: convergence, smashed relays, Sundered Gate approach. No town garrisons. Let people sleep without gold-black nightmares; starve the Council's fear file; make Garrett's audit one notch less absurd.

Ninety-two routes rewrite. Dren's north folds in; eastern pickets slide to the main ring — one circuit through dead ground, guarding the wound, not the inns.
