...
| 21 | Bonded Lovers | +1 STR/CON per intimate partner (22 partners = +22/+22). Stats maintained without proximity. |
| 24 | Soul Nexus | All partner abilities active passively. Regen 333/turn. Blade Dance. Aether Shield. Diagnostic Touch. Hearthsense. Living Ground. Bloodlust (Mursha — +25% stats/kill). Seal Reader (Haldra — forgery detection by touch). Verbal Archive (Haldra — 1/LR perfect spoken recall 24h). Scribe's Eye (Tamsin — passive omnilingual literacy). Paper Memory (Tamsin — 1/LR perfect document recall 24h). Etc. |
