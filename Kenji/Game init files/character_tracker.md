...
**Active PC:** Cookie — Halfling Ankuspawn Dancer (Level 5)
**Current In-Game Date:** Windday, 4 Bright Turn 1247 AR — **Day 4, ~14:00** — **Burnt Amphitheatre, south of Varenholm**
**Campaign:** Cookie — starter campaign (levels 1–10)
**Chapter:** 4 COMPLETE | Chapter 5 pending
**EXP:** 35,523 / 40,000 (4,477 to go)
...
**Status:** alive
**Level:** 5 — 35,523 / 40,000 EXP (4,477 to next)
**Location:** Burnt Amphitheatre, south of Varenholm — Day 4, 14:00. Ch4 COMPLETE.
**HP:** 35/35 | **AC:** 14 | **Proficiency:** +3
**Saves:** DEX +7, CHA +7, WIS −2
**Skills:** Performance +9, Persuasion +9, Acrobatics +7, Deception +6
**Spells:** L1: 4/4, L2: 3/3
**Wealth:** 3 GP, 0 SP, 95 CP
**Last Updated:** Day 4 — Ch4 close
...
- **Chorus of One (active, 3/day):** Bonus action, 60 ft. Bolster (3 allies: 1d8+CHA temp HP + adv next save) or Disorient (3 enemies: CON DC 13, disadv attacks + −10 ft move, 1 round).
...
DEX-based martial art created during Ch2 bandit camp raid. High risk, high reward.
- **Kick:** 1 per round. d20 + DEX + prof to hit. 1d6 bludgeoning. Always causes PRONE on hit.
...
|---------|--------|----------|--------|-------------|
| become_famous_bard | Day 1 | ongoing | ACTIVE | Become a famous bard like Ignis. Enrolled at Academy, V.E.A. registered, Starling show booked Day 5, Torren promoting, outfits commissioned, earring deal with Isolde. |
...
| earring_pickup | Day 3 | Day 5 AM | ACTIVE | Custom enchanted earrings (+2 CHA, adv Persuasion & Performance) from Isolde at The Pale Lantern. Advertising deal — wear at Starling. |
| starling_show | Day 1 | Day 5 EVE | ACTIVE | First major performance at The Starling. Torren promoting to patrons. Career-defining moment. |
...
| **Gilt Lily barkeep** | TN | 1 | Inn barkeep | active | Stocky woman, cropped hair. Gave Cookie intel on Torren. |
| **Maeven** | TN | 2 | Tailor, Chandler's Row | active | Fitted Cookie's indigo dress. Professional. |
| **Gruff** | LN | 2 | Adventurer's Guild clerk | active | Handles quest postings and party registration. |
| **Dorith** | NG | 2 | Adventurer healer | active | Party member (bandit camp, survey stones). |
| **Dalla** | TN | 2 | Adventurer fighter | active | Party member. Cookie stays close to her in dangerous situations. |
| **Silas** | CN | 2 | Adventurer rogue | active | Party member. |
| **Marta** | NG | 2 | Adventurer ranger | active | Party member. Tracked cart ruts to Castor's farm. |
| **Garron** | TN | 2 | Adventurer crossbowman | active | Party member. Originally "Fen," renamed to avoid confusion with Fern. |
| **Alderman Edric Tosse** | LN | 3 | City official | active | Posted Missing Survey Stones quest. Male (Pretty Privilege: 6 SP → 6 GP). |
| **Castor** | TN | 3 | Turnip farmer | active | Stole 3 survey stones. Caught. Fined 2 GP + 30 days labor. |
| **Isolde** | TN | 3 | Enchantress, The Pale Lantern | active | Apprenticed under Maren Holt (Gilt Lens). Female — immune to Pretty Privilege. Aware of Heartstring but not swayed (enchantment experience). Struck advertising deal: 85 GP earrings for 4 GP + Starling promotion. |
...
**Phase 2** (L4-6): Cookie becomes known. Lyssa notices. Practice room trashed. Note: "The heartland has enough bards."
**Phase 3** (L7-9): Escalation. Fern charmed and turned. Cookie discovers the Sunken Playhouse and the Resonance Chamber. Young bronze dragon recognizes her Ember.
...
7. **Starling performance (Day 5)** — Career-defining. Torren promoting to patrons. Isolde's earring deal means the enchantress is invested in Cookie's success. High visibility = Silka's report triggers faster.
