...
**Current In-Game Date:** Ashmere **54** morning, 1247 AR — **Day** **276** — **Ashenmere** **(coalition port city, Red Court territory)**  
**Current Location:** **Kenji** **—** **Ashenmere**, coaching inn near portal district. **IDENTITY: ANKU NYX (open)** — green eyes, tattoos, aura visible; no mask, no hat, no disguise. Registered at **Alabaster Court** social club as "Anku Nyx." Coalition formal wear. Nyx beside him (Lady form, green dress, loose curls). **Alabaster Court salon tomorrow (Restday evening) — Madame Lysenne introduction.** Red Court recon active — Nyx identified 3 vampires in Court library. Puppet-Gorath operational at Varkûl (portal anchored nearby). 20K orc blockade on Kharn roads (ordered Ch37). Corwyn at Pallid March. **Mursha** **—** **still** **Kharn** **witness-engineer**. **Purse** **~1295 GP / 181 SP**. **HP 6,288/6,288** (regen 1,048/sec); all charges at LR values; **L6: 2/2** (full — long rest).
