...
| Stat | Base | Bonded Lovers | Ring | Boots | Total | Mod |
|------|------|--------------|------|-------|-------|-----|
| STR  | 20   | +12          | +2   |       | 34    | +12 |
| DEX  | 18   |              |      | +2    | 20    | +5  |
| CON  | 20   | +12          |      |       | 32    | +11 |
...
- **Level:** 35
- **EXP:** 2,200,000 / 2,500,000 (Level 40)
...
## SOUL NEXUS (12 Partners)

| Partner | Skill | Perk |
|---------|-------|------|
| Senna | Flurry/Evasion | Regeneration (100% HP/turn) |
| Lythara | Forest Sense | Forest Bond |
| Pip | Appraisal | Golden Tongue |
| Della | Steady Hands | Tip Jar |
| Faelindra | Blade Dance (3 atk/round) | Ironwood Discipline (immune fear/charm/stun) |
| Nimue | Aether Shield (absorb+store spells) | Cascade (overkill splashes) |
| The Eldest | Sovereign's Voice (DC 23 pause) | Ley Sovereign (sense/redirect ley) |
| Sera | Dual Strike Mastery (+2/+1d6 dual-wield) | Unbreakable Bond (+2 AC w/ partner) |
| Thessaly | Archive Recall (Legend Lore free) | Field Notes (read all enemy stats) |
| Elara | Counterspell Mastery (no slot, 3/LR) | Spell Eater (heal on counterspell) |
| Vess | War Room (+10% efficiency) | Institutional Memory (ADV govt CHA) |
| Katya | Surrender Terms (DC 23 army surrender) | War Prize (50% enemy conversion) |
...
- **The Long Memory** (GOOD) — pattern recognition across time. Functional.
- **God Sight** — crit 18-20, perception, darkvision. Permanently available via captured nodes.
- **Giant's Throw** — 3x range, +50% thrown damage. Permanently available.
- **Haste** — +2 AC, extra action, ADV DEX saves
- **Arcane Stride** — 150ft movement
- **Duality Aspect** — Creation (60ft heal AOE) / Entropy (60ft necrotic AOE)
- **Enhanced Arcane Edge** — +1d8 force per hit + Arcane Momentum (free atk per kill)

---

## INTIMATE PARTNERS (12)
...
- **Emberfrost** — double blade. d8+STR slash + 1d6 fire + 1d8 cold. Duality modes.
- **Instructor's Guard** — leather armor. AC 15 + DEX + cross-guard +2 + enchant +1.
- **Windstrider Boots** — DEX +2, +5 Acrobatics, 20% dodge, silent, no tracks.
- **Ring of Strength** — STR +2.
- **Circuit Bracelet** — former Hollow Crown. Construct command interface.
- **Whisper Stones** — full network, all allies.
- **Storage Ring** — inventory management.

---

## TITLES

- **ArchMagus of Varenholm** — Academy rank
...
**Noble's Interest:** 50%/day compound on reserves
...
- **Katya Voss commanding:**
  - 6,000 converted Dominion soldiers (War Prize)
...
| NPC | Location | Role |
|-----|----------|------|
| Garrett | Crestfall | Civil service (80 staff) |
| Aldwin | Varenholm | War College Dean |
...
| Lena | Village | OPEN THREAD — Book 4 hook |
| Mordecai | UNKNOWN | Gentleman's understanding. Gone. |
...
1. **Lena** — the thread that waited
2. **Mordecai** — gone, building something
3. **Bane of Eve** — daily encounters (not a campaign, a content layer)
...
- **Book 2 manuscript** (`Kenji_story_book2.md` and `Book 2/Chapters/`): opens with **prelude — *The Gilt Conspiracy*** (Day Thirteen lead-in chapters) so the Hollow Crown / guild beat flows straight into ***The Sundered Gate***. That prelude is the bridge from Book 1’s main novel; the numbered `kenji_chapter_*.md` files pick up at *New Skin* as Sundered Gate **Chapter One** in-book.
- **Handoff:** the Sundered Gate arc **leads into** **Book 3 — *The Iron Crown War*** (prose in `Book 3/Chapters/`, e.g. `iron_crown_*.md`). Gate → war is the spine; no gap in intended reading order.
- **Single-file Book 2:** `Kenji_story_book2.md` is the full prelude + Sundered Gate manuscript (through Chapter Twenty-Four); `Book 2/Chapters/` holds per-chapter exports for edits.
