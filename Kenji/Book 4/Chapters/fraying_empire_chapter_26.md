...
- **Gameplay:** **Day** **260** **predawn** **→** **Day** **261** **morning** — **Kharn** **inner** **works**. **Mursha:** **perimeter** **discipline**; **clocks** **Kenji** **rejoin** **(**gut** **lag** **/** **Ch18** **flicker** **memory** **—** **no** **public** **accusation**)**; **warns** **vs** **forge-sight** **clerk**; **supply** **niche** **beat** **—** **Oathbreaker** **almost** **(**Marthel**)** **/** **deferred** **again**. **Factor** **train** **moves** **inward** **one** **tier** **(**Hollowing** **pressure** **ambient**)**. **Clone** **swap** **:** **if** **table** **spent** **charge** **→** **Smoke-Invis-Clone** **1/3** **(**else** **unchanged**)**.
- **Combat:** **None.**
- **EXP:** **2,270,050** (unchanged). **229,950** to **Apotheosis**.
- **Resources:** **1385** **GP**, **191** **SP** **(**sync** **table**)**; **Wind** **Step** **3/5**; **Iaido** **0/1**.
- **Character:** **Mursha** **—** **authority** **without** **theater**; **trust** **strain** **unnamed** **re** **absence**; **contract** **frame** **holds**. **Kenji** **—** **silent** **posture** **(**player** **lines** **only**)**.
- **Relationship:** **Mursha** **48** **(**table**)**.
- **Intel / threat:** **Forge-sight** **clerk** **still** **in** **sightlines**; **tube** **+** **train** **inward**; **Tamsin** **/** **scribe** **thread** **orthogonal** **unless** **paths** **cross** **in** **yard**.
- **Ends:** Ashmere 39, Day 261, morning — Kharn yard tier inward of outer checkpoint; factor train repositioned; Kenji + Mursha in escort geometry; EXP 2,270,050 / 2,500,000; **1385 GP**, 191 SP; charges per table; HP 368.

---

**Next beat (played — Ch27):** **Manifest** **Revision** **/** **checkpoints** — see `fraying_empire_chapter_27.md`.
