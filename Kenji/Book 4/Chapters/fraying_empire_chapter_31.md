...
- **Gameplay:** **Day** **261** **late** **night** **→** **Day** **262** **predawn** — **social** **/** **threat** **/** **engineering** **politics** **/** **escape** **sequence**. **Performance** **23** **vs** **DC** **16** **PASS** **(**clone** **distraction**)**. **Stealth** **ADV** **+5** **(**d20** **13** **used** **)** **total** **18** **vs** **DC** **16** **PASS** **(**G.** **Invis** **;** **distraction** **−2** **vs** **gate** **18** **)**.
- **Combat:** **None** **formal**; **ward** **/** **breach** **protocol** **threads** **open** **on** **Kharn** **side**.
- **EXP:** **2,270,050** **baseline** **(**table** **may** **award** **milestone**)**.
- **Resources:** **Smoke-Invis-Clone** **1/3** **after** **egress** **(**was** **2/3** **;** **spent** **1** **)**; **Wind** **Step** **1/5** **(**spent** **2** **on** **egress** **/** **distance** **—** **sync** **`kenji_state.json`****)**; **Iaido** **0/1**.
- **Character:** **Kenji** **—** **off** **Kharn** **cordons** **(**relay** **flags** **likely****)**; **identity** **still** **on** **slate**. **Mursha** **—** **witness**-**engineer** **under** **ruling** **bundle**; **Solveth** **stays** **in** **seam** **work** **(**pull** **plan****)**. **Korrim** **—** **breach** **/** **decoy** **entries** **entered**.
- **Relationship:** **Mursha** **/** **Kenji** **—** **trust** **stress** **+** **duty** **braid**; **she** **accepts** **his** **apology** **beats** **but** **not** **his** **schedule** **ownership**.
- **Intel / threat:** **Coalition** **relay** **+** **Kharn** **decoy** **/** **invisible** **egress** **on** **record**; **veiled** **gallery** **still** **live**; **seam** **blades** **still** **wedged**.
- **Ends:** **Day** **262** **predawn**, **remote** **location** **post**-**portal** **(**player**-**defined** **off** **path****)**; **HP** **368/368**; **EXP** **2,270,050**; **1435** **GP** **/** **191** **SP** **unchanged** **unless** **table** **adjusts**.

---

**Resolved in Ch30** (`fraying_empire_chapter_30.md` — *Trapped With Me*): **wedge** **draft** **ready**; **non**-**contact** **wards**; **Champion** **/** **Archmagus** **on** **slate**.

**Next beat (open — Ch32):** **`fraying_empire_chapter_32.md`** **—** **Mursha** **/** **wright** **two**-**phase** **pull** **without** **Kenji** **in** **room**; **relay** **hunt** **/** **coalition** **ping**; **Solveth** **editorial** **risk**; **Kenji** **surface** **somewhere** **safe** **or** **not**; **veiled** **observer** **next** **move**; **BoH** **traveler** **plant** **(**Ch27**)** **still** **a** **time** **bomb** **unless** **recovered** **elsewhere**.
