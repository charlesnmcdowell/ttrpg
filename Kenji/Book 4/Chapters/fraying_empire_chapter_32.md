...
- **Gameplay:** **Day** **262** **morning** — **recovery** **/** **economy** **beat** **(**no** **checks** **required** **unless** **DM** **adds** **gossip** **/** **recognition** **)**.
- **Combat:** **None**.
- **EXP:** **2,270,050** **baseline**.
- **Resources:** **−**40 **GP**, **−**10 **SP** **(**suite** **+** **fine** **dining** **approx** **)**; **LR** **:** **Wind** **Step** **5/5**, **Smoke**-**Invis**-**Clone** **3/3**, **Iaido** **1/1**, **spell** **slots** **full**, **HP** **368/368**.
- **Character:** **Kenji** **—** **rested**, **fed**, **off** **Kharn** **immediate** **glass** **(**not** **off** **relay** **interest** **)**.
- **Relationship:** **Mursha** **—** **not** **present**; **clock** **still** **two** **weeks** **/** **her** **call**.
- **Intel / threat:** **Relay** **rumor** **lag** **may** **close**; **luxury** **spend** **on** **ronin** **silhouette** **feeds** **identity** **pressure** **if** **witnessed**.
- **Ends:** **Ashmere** **40**, **Day** **262** **~07:30** **—** **Milepost** **Crown** **Rest** **luxury** **suite**; **1395** **GP**, **181** **SP**; **HP** **368/368**.

---

**Resolved in Ch31** (`fraying_empire_chapter_31.md` — *Two Weeks and a Green Door*): **egress** **/** **portal** **exit**.

**Next beat (open — Ch33):** **Leave** **waystation** **vector** **(**north** **/** **south** **/** **portal** **hub** **)**; **relay** **message** **arrives** **(**Kharn** **/** **coalition** **)**; **Mursha** **remote** **beat** **optional**; **traveler** **BoH** **plant** **clock**.
