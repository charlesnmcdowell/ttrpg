...
- **Gameplay:** **Day** **261** **Ashmere** **39** **morning–afternoon** — **Kharn** **yard** **Tier** **I** **→** **II**. **Mursha** **states** **dual** **objective** **(**contract** **+** **quarantine** **truth**)** **per** **`arcs/ARC_STANDARD.md`** **spine**. **Coin** **distraction** **+** **Sleight** **contest** **(**Kenji** **16** **vs** **dwarf** **4**)** — **unwitting** **traveler** **now** **bears** **repositioned** **extradimensional** **/** **kit** **(**moral** **+** **inspection** **time** **bomb** **elsewhere** **in** **queue**)**. **First** **checkpoint** **pass**. **Manifest** **Revision** **II:** **Kenji** **reads** **slate** **/** **marginalia** **(**table** **literacy** **tool**)**; **forge-sight** **palms** **check** **→** **pass**; **directed** **to** **cargo** **reconciliation**. **Mursha** **:** **cover** **discipline** **on** **literacy** **tell**.
- **Combat:** **None.**
- **EXP:** **2,270,050** (unchanged). **229,950** to **Apotheosis**.
- **Resources:** **1385** **GP**, **191** **SP** **(**minus** **trivial** **coin** **if** **table** **tracks**)**; **Wind** **Step** **3/5**; **Smoke-Invis-Clone** **per** **Ch26** **/** **swap** **table**; **Iaido** **0/1**.
- **Character:** **Mursha** **—** **arc** **motive** **spoken** **clear**; **professional** **terror** **re** **Kenji’s** **public** **reads** **/** **moves**. **Kenji** **—** **player** **lines** **only** **in** **prose** **body**; **sleight** **plant** **creates** **downstream** **NPC** **risk**.
- **Relationship:** **Mursha** **48** **(**table**)** — **trust** **strain** **if** **she** **learns** **plant** **full** **detail**.
- **Intel / threat:** **Forge-sight** **round** **two** **partially** **resolved** **(**pass**)**; **young** **dwarf** **carrier** **unresolved**; **cargo** **reconciliation** **next**; **Hollowing** **ambient** **pulse** **deeper** **tier**.
- **Ends:** Ashmere 39, Day 261, afternoon — past Manifest Revision II; approaching cargo reconciliation; Kenji + Mursha clean this beat; **1385 GP**, 191 SP (±coin); HP 368/368; EXP 2,270,050 / 2,500,000.

---

**Next beat (played — Ch28):** **Quarantine** **forge** **/** **conduit** **vent** — see `fraying_empire_chapter_28.md`.
